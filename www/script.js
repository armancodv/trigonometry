...
app.controller('myCtrl', function($scope) {
	...
	$scope.info_name = ['Basic','Symmetry, shifts, and periodicity','Angle sum and difference','Double angle','Triple angle','Half angle','Power reduction','Product to sum','Sum to product','Inverse trigonometric','Derivative','Exponential']
